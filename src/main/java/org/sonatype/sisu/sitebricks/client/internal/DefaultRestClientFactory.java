...
class DefaultRestClientFactory<S>
    implements RestClientFactory<S>
{
    ...
    public S create( final URL baseUrl )
    {
        ...
        return (S) newProxyInstance( serviceInterface.getClassLoader(), interfaces, new DefaultRestClient( web,
            transport.getObjectMapper(), serviceInterface, bindings, baseUrl ) );
    }
